...
public class Tasks {
    ...
    {
        JDBC.connection.createStatement().executeUpdate("INSERT INTO publishers(\"publisherName\") VALUES ('Amongus')");
        JDBC.connection.createStatement().executeUpdate("INSERT INTO titles(isbn, title, \"editionNumber\", year, \"publisherID\", price) VALUES\r\n"
                + "	('5343175416', 'Demons', 1, 1888, (select \"publisherID\" from publishers where \"publisherName\" = 'Amongus'), 8.82);");
        JDBC.connection.createStatement().executeUpdate("INSERT INTO authorisbn VALUES ((SELECT \"authorID\" "
